...
const envSchema = z.object({
  ...
  CACHE_ANALYTICS_TTL_SECONDS: z.coerce.number().int().positive().optional(),
  CACHE_CITIZEN_TTL_SECONDS: z.coerce.number().int().positive().optional(),
  CACHE_DASHBOARD_TTL_SECONDS: z.coerce.number().int().positive().optional(),
  CACHE_DEFAULT_TTL_SECONDS: z.coerce.number().int().positive().optional(),
  CACHE_ENABLED: z.enum(['true', 'false']).optional(),
  CACHE_MAX_MEMORY_ENTRIES: z.coerce.number().int().positive().optional(),
  CACHE_PLANNING_TTL_SECONDS: z.coerce.number().int().positive().optional(),
  ...
  RESPONSE_COMPRESSION_ENABLED: z.enum(['true', 'false']).optional(),
  RESPONSE_COMPRESSION_LEVEL: z.coerce.number().int().min(-1).max(9).optional(),
  RESPONSE_COMPRESSION_THRESHOLD_BYTES: z.coerce.number().int().positive().optional(),
  PLANNING_SSE_ENABLED: z.enum(['true', 'false']).optional(),
  PLANNING_WEBSOCKET_ENABLED: z.enum(['true', 'false']).optional(),
  PLANNING_REALTIME_INTERVAL_MS: z.coerce.number().int().positive().optional(),
  PLANNING_REPORTS_ENABLED: z.enum(['true', 'false']).optional(),
  ADMIN_WORKSPACE_ENABLED: z.enum(['true', 'false']).optional(),
  BILLING_ENABLED: z.enum(['true', 'false']).optional(),
  CITIZEN_CHALLENGES_ENABLED: z.enum(['true', 'false']).optional(),
